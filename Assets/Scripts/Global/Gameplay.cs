...
public class Gameplay : MonoBehaviour
{
    ...
    //¬ыполнить проверку состо€ний текущей миссии
    void TestMission() {
        //если в этом кадре не провер€ли
        if (buffer.missionTestTime != Time.unscaledTime)
        {
            //—тавим врем€ последней проверки
            buffer.missionTestTime = Time.unscaledTime;

            //ƒелаем параметры по умолчанию
